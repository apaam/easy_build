...
cmake ${CMAKE_GENERATOR_FLAG} \
  ...
  -DBUILD_OPENFOAM=${OPENFOAM} \
  -DBUILD_PERIDIGM=${PERIDIGM} \
  -DBUILD_SCOTCH=${SCOTCH} \
  ...
  -DMPI_CXX_COMPILER=${MPI_CXX_COMPILER} -DMPI_C_COMPILER=${MPI_C_COMPILER} \
