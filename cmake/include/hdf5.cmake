...
if(USE_INTERNAL_HDF5)
  set(HDF5_EP_ROOT ${CONTRIB_ROOT_DIR}/hdf5/ep)
  set(HDF5_SOURCE_DIR ${CONTRIB_ROOT_DIR}/hdf5/src)
  set(HDF5_BUILD_DIR ${CONTRIB_ROOT_DIR}/hdf5/build)
  set(HDF5_INSTALL_DIR ${CONTRIB_ROOT_DIR}/hdf5/install)
  ...
  ExternalProject_Add(
    ...
    CONFIGURE_COMMAND
      ...
      -DCMAKE_C_COMPILER=${MPI_C_COMPILER} -DHDF5_ENABLE_PARALLEL=ON
