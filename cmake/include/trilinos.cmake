...
if(USE_INTERNAL_TRILINOS)
  set(TRILINOS_EP_ROOT ${CONTRIB_ROOT_DIR}/contrib/trilinos/ep)
  set(TRILINOS_SOURCE_DIR ${CONTRIB_ROOT_DIR}/contrib/trilinos/src)
  set(TRILINOS_BUILD_DIR ${CONTRIB_ROOT_DIR}/contrib/trilinos/build)
  set(TRILINOS_INSTALL_DIR ${CONTRIB_ROOT_DIR}/contrib/trilinos/install)
  ...
  ExternalProject_Add(
    ...
    CONFIGURE_COMMAND
      ...
      -DBLAS_INCLUDE_DIRS=${OPENBLAS_INCLUDE_DIRS}
      -DBLAS_LIBRARY_DIRS=${OPENBLAS_LIBRARY_DIRS}
      -DBLAS_LIBRARY_NAMES=${OPENBLAS_LIBRARIES} -DTPL_ENABLE_LAPACK=ON
  ...
  if(USE_INTERNAL_LAPACK)
    add_dependencies(TRILINOS LAPACK)
  ...
  set(TRILINOS_LIBRARIES trilinosss)
