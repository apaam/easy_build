...
if(USE_INTERNAL_HWLOC)
  set(HWLOC_EP_ROOT ${CONTRIB_ROOT_DIR}/hwloc/ep)
  set(HWLOC_SOURCE_DIR ${CONTRIB_ROOT_DIR}/hwloc/src)
  set(HWLOC_BUILD_DIR ${CONTRIB_ROOT_DIR}/hwloc/build)
  set(HWLOC_INSTALL_DIR ${CONTRIB_ROOT_DIR}/hwloc/install)
