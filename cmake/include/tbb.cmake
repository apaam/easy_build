...
if(USE_INTERNAL_TBB)
  set(TBB_EP_ROOT ${CONTRIB_ROOT_DIR}/tbb/ep)
  set(TBB_SOURCE_DIR ${CONTRIB_ROOT_DIR}/tbb/src)
  set(TBB_BUILD_DIR ${CONTRIB_ROOT_DIR}/tbb/build)
  set(TBB_INSTALL_DIR ${CONTRIB_ROOT_DIR}/tbb/install)
