...
if(USE_INTERNAL_PETSC)
  set(PETSC_EP_ROOT ${CMAKE_SOURCE_DIR}/contrib/petsc/ep)
  set(PETSC_SOURCE_DIR ${CMAKE_SOURCE_DIR}/contrib/petsc/src)
  set(PETSC_BUILD_DIR ${CMAKE_SOURCE_DIR}/contrib/petsc/src)
  set(PETSC_INSTALL_DIR ${CMAKE_SOURCE_DIR}/contrib/petsc/install)
