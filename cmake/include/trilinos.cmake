...
if(USE_INTERNAL_TRILINOS)
  set(TRILINOS_EP_ROOT ${CONTRIB_ROOT_DIR}/trilinos/ep)
  set(TRILINOS_SOURCE_DIR ${CONTRIB_ROOT_DIR}/trilinos/src)
  set(TRILINOS_BUILD_DIR ${CONTRIB_ROOT_DIR}/trilinos/build)
  set(TRILINOS_INSTALL_DIR ${CONTRIB_ROOT_DIR}/trilinos/install)
