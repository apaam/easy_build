...
if(USE_INTERNAL_OPENFOAM)
  set(OPENFOAM_EP_ROOT ${CONTRIB_ROOT_DIR}/openfoam/ep)
  set(OPENFOAM_SOURCE_DIR ${CONTRIB_ROOT_DIR}/openfoam/OpenFOAM-dev)
  set(OPENFOAM_BUILD_DIR ${CONTRIB_ROOT_DIR}/openfoam/OpenFOAM-dev)
  set(OPENFOAM_INSTALL_DIR ${CONTRIB_ROOT_DIR}/openfoam/install)
