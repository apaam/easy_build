...
if(USE_INTERNAL_GLFW)
  set(GLFW_EP_ROOT ${CONTRIB_ROOT_DIR}/glfw/ep)
  set(GLFW_SOURCE_DIR ${CONTRIB_ROOT_DIR}/glfw/src)
  set(GLFW_BUILD_DIR ${CONTRIB_ROOT_DIR}/glfw/build)
  set(GLFW_INSTALL_DIR ${CONTRIB_ROOT_DIR}/glfw/install)
