...
if(USE_INTERNAL_EMBREE)
  set(EMBREE_EP_ROOT ${CONTRIB_ROOT_DIR}/embree/ep)
  set(EMBREE_SOURCE_DIR ${CONTRIB_ROOT_DIR}/embree/src)
  set(EMBREE_BUILD_DIR ${CONTRIB_ROOT_DIR}/embree/build)
  set(EMBREE_INSTALL_DIR ${CONTRIB_ROOT_DIR}/embree/install)
